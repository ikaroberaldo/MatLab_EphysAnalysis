classdef Sleep_archictecture_interface_exported < matlab.apps.AppBase
...
%                     x_ticks = round(duration_bouts_UI.XTick * (length(app.All_Sort) * app.rdStepSelecttheEpochLengthSecEditField.Value / 3600),1);
    ...
    methods (Access = private)
        ...
        function SaveButtonPushed(app, event)
            ...
            % Save as matfile
            architecture_filename = fullfile(filepath,'architecture');
            save(architecture_filename,'Segment*','Number*','Duration*','Time*')
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIAxes_3.PlotBoxAspectRatio = [5.90476190476191 1 1];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Sleep_archictecture_interface_exported
